...
export const initialPageData: { [key: string]: PageData } = {
  page1: {
    ...
    tableSet: [{ id: uuidv4(), x: 200, y: 200, width: 300, height: 200, rows: 3, columns: 3 }],
    textareaSet: [{ id: uuidv4(), x: 50, y: 50, width: 250, height: 100, placeholder: "Enter text", underline: true }],
  },
};
