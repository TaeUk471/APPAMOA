...
const EditHeader = () => {
  ...
  return (
    <>
      <header
        className={`sticky top-0 right-0 z-30 flex items-center justify-between h-[70px] shadow-md p-4 border-t-4 ${
          pathname?.includes("/template") ? "border-blue-800 bg-blue-100" : "border-purple-800 bg-purple-100"
        }`}>
